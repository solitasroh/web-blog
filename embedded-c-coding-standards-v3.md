...
|------|-----------|---------|-----------|-----------|
| **BARR-C:2018** | Barr Group | 약 60개 | 스타일 + 버그 방지 | 매우 좋음 |
...
Apple의 "goto fail" 버그를 기억하라. 중괄호 하나 때문에 SSL 보안이 무너졌다.
...
Linux Kernel 스타일은 스타일 중심이다. 안전성 규칙은 부족해서 ARM 임베디드에는 부적합하다.
...
갑자기 모든 규칙을 적용하면 팀이 거부한다. 신규 코드부터 시작해서 천천히 확장하는 게 답이다.
